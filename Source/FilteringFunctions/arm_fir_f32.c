...
static void update_fir_f32_1(float32x4_t *accv0,
                             float32x4_t *accv1,
                             float32x4_t x0,
                             float32x4_t x1,
                             float32x4_t b)
...
static void update_fir_f32_2(float32x4_t *accv0,
                             float32x4_t *accv1,
                             float32x4_t *accv2,
                             float32x4_t *accv3,
                             float32x4_t x0,
...
static void update_fir_f32_3(float32x4_t *accv0,
                             float32x4_t *accv1,
                             float32x4_t *accv2,
                             float32x4_t *accv3,
                             float32x4_t x0,
...
static void update_fir_f32(float32x4_t *accv0,
                           float32x4_t *accv1,
                           float32x4_t *accv2,
                           float32x4_t *accv3,
                           float32x4_t x0,
...
#define INNER_LOOP_COEF_32_35()                                             \
    ...
    x2 = vld1q_f32(px + 8);                                                 \
                                                                            \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[0]);       \
                                                                            \
    x0 = vld1q_f32(px + 12);                                                \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[1]);       \
                                                                            \
    x1 = vld1q_f32(px + 16);                                                \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[2]);       \
                                                                            \
    x2 = vld1q_f32(px + 20);                                                \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[3]);       \
                                                                            \
    x0 = vld1q_f32(px + 24);                                                \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[4]);       \
                                                                            \
    x1 = vld1q_f32(px + 28);                                                \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[5]);       \
                                                                            \
    x2 = vld1q_f32(px + 32);                                                \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[6]);       \
                                                                            \
    x0 = vld1q_f32(px + 36);                                                \
    update_fir_f32(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[7]);       \
                                                                            \
    switch (nTail)                                                          \
    {                                                                       \
    case 0:                                                                 \
    ...
    case 1:                                                                 \
        ...
        update_fir_f32_1(&accv0, &accv1, x2, x0, b[8]);                     \
        break;                                                              \
    case 2:                                                                 \
        x1 = vld1q_f32(px + (nTaps) * 4 + 8);                               \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[8]); \
        break;                                                              \
    case 3:                                                                 \
        x1 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[8]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_COEF_28_31()                                             \
    ...
    case 1:                                                                 \
        ...
        update_fir_f32_1(&accv0, &accv1, x1, x2, b[7]);                     \
        break;                                                              \
    case 2:                                                                 \
        x0 = vld1q_f32(px + (nTaps) * 4 + 8);                               \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[7]); \
        break;                                                              \
    case 3:                                                                 \
        x0 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[7]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_COEF_24_27()                                             \
    ...
    case 1:                                                                 \
        ...
        update_fir_f32_1(&accv0, &accv1, x0, x1, b[6]);                     \
        break;                                                              \
    case 2:                                                                 \
        x2 = vld1q_f32(px + (nTaps) * 4 + 8);                               \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[6]); \
        break;                                                              \
    case 3:                                                                 \
        x2 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[6]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_COEF_20_23()                                             \
    ...
    case 1:                                                                 \
        x1 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_1(&accv0, &accv1, x2, x0, b[5]);                     \
        break;                                                              \
    case 2:                                                                 \
        x1 = vld1q_f32(px + (nTaps) * 4 + 8);                               \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[5]); \
        break;                                                              \
    case 3:                                                                 \
        x1 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[5]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_COEF_16_19()                                             \
    ...
    case 1:                                                                 \
        x0 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_1(&accv0, &accv1, x1, x2, b[4]);                     \
        break;                                                              \
    case 2:                                                                 \
        x0 = vld1q_f32(px + (nTaps) * 4 + 8);                               \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[4]); \
        break;                                                              \
    case 3:                                                                 \
        x0 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[4]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_COEF_12_15()                                             \
    ...
    case 1:                                                                 \
        x2 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_1(&accv0, &accv1, x0, x1, b[3]);                     \
        break;                                                              \
    case 2:                                                                 \
        x2 = vld1q_f32(px + (nTaps) * 4 + 8);                               \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[3]); \
        break;                                                              \
    case 3:                                                                 \
        x2 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[3]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_COEF_8_11()                                              \
    ...
    case 1:                                                                 \
        x1 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_1(&accv0, &accv1, x2, x0, b[2]);                     \
        break;                                                              \
    case 2:                                                                 \
        x1 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[2]); \
        break;                                                              \
    case 3:                                                                 \
        x1 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x2, x0, x1, b[2]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_COEF_4_7()                                               \
    ...
    case 1:                                                                 \
        x0 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_1(&accv0, &accv1, x1, x2, b[1]);                     \
        break;                                                              \
    case 2:                                                                 \
        x0 = vld1q_f32(px + (nTaps) * 4 + 8);                               \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[1]); \
        break;                                                              \
    case 3:                                                                 \
        x0 = vld1q_f32(px + nTaps * 4 + 8);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x1, x2, x0, b[1]); \
        break;                                                              \
    default:                                                                \
        break;                                                              \
    }
...
#define INNER_LOOP_GENERIC()                                                \
    ...
    case 1:                                                                 \
        ...
        update_fir_f32_1(&accv0, &accv1, x0, x1, b[0]);                     \
        break;                                                              \
    case 2:                                                                 \
        b[0] = vld1q_f32(pb + (nTaps) * 4);                                 \
        update_fir_f32_2(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[0]); \
        break;                                                              \
    case 3:                                                                 \
        b[0] = vld1q_f32(pb + (nTaps) * 4);                                 \
        update_fir_f32_3(&accv0, &accv1, &accv2, &accv3, x0, x1, x2, b[0]); \
        break;                                                              \
                                                                            \
    default:                                                                \
        break;                                                              \
...
ARM_DSP_ATTRIBUTE void arm_fir_f32(const arm_fir_instance_f32 *S,
                                   const float32_t *pSrc,
                                   float32_t *pDst,
                                   uint32_t blockSize)
{
